        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    String Query3 = "insert into trans (dat, accountID, credit, balance) values(?,?,?,?)";
                    ...
                    ps.executeUpdate();
                            ...
                            out.println("<center><h1>Amount Successfully Deposit</h1></center></br>");
                            out.println("<center><a href='deposit.jsp'>Click here to Deposit More Amount.</a></center></br>");
