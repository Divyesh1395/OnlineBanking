...
function valid(form)
{
   ...
   if(!isNaN(document.F1.targetAcc.value))
   {
       if((999999999 > document.F1.targetAcc.value) || (document.F1.targetAcc.value > 9999999999))
	   {
                alert("Enter Valid 10 digits Target Account number");
                document.F1.targetAcc.value="";
                document.F1.targetAcc.focus();
                return false;
           }
   }
   else
   {
        alert("Target Account  must  be  number");
        document.F1.targetAcc.value="";
        document.F1.targetAcc.focus();
	return false;
   }
   if(document.F1.accountno.value == document.F1.targetAcc.value)
    {
	   alert("Change Target Account Number"); 
	   document.F1.targetAcc.value="";
	   document.F1.targetAcc.focus();	
	   return false;
	}
...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="formArea" style="border-right:#666666 1px dotted;"><h1>TRANSFER FORM</h1><br>
    	    <table  align="center" bgcolor="white">
		<tr>
			<td>
				<form name=F1 onSubmit="return valid(this)" action="TransferServlet" method="post">
					...
					<tr><td>TARGET ACCOUNT NO:</td><td><input type="text" name="targetAcc" style="width:250px; height:25px;"/></td></tr>
					<tr><td>AMOUNT:</td><td> <input type="text" name="amount" style="width:250px; height:25px;"/></td></tr>
					<tr></tr><tr></tr>					
