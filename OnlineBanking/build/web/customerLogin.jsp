...
<div id="navigation">
    <ul>
    <li style="width:150px; float:right; border-left:1px solid #282828;"><a href="index.html">HOME</a></li>
    </ul>
</div>
...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="formArea" style="border-right:#666666 1px dotted;"><h1>LOGIN AS A CUSTOMER</h1><br>
    	    <table  align="center" bgcolor="white">
		<tr>
			<td>
                            <form name=F1 onSubmit="return valid(this)" action="CustomerLoginServlet" method="post">
				     <table cellspacing="5" cellpadding="3">
					<tr><td>USER NAME:</td><td> <input type="text" name="username" style="width:250px; height:25px;"/></td></tr>
